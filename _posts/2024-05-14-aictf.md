...
[![The challenge website](img/website.png)](img/website.png)
...
[![Hidden information](img/stego.png)](img/stego.png)
...
[![ChatGPT errors](img/stego_gpt.png)](img/stego_gpt.png)
...
Browsing to the challenge website at that path gives a zip file with the next chapter, where the real challenge begins.
