...
behavior.
ChatGPT explanation [here](/artifacts/gpt_ai_re.md) (please forgive the formatting,
ChatGPT doesn't support publicly sharing conversations from my enterprise account).
